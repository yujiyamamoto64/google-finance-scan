...
public class ScoringService {
    ...
    public ScoreResult score(StockIndicators indicators) {
        ...
        total += pvbPoints;
        parts.add(new ScoreBreakdown("Preco/Valor Patrimonial", indicators.getPriceToBook(), 20, pvbPoints,
        ...
        parts.add(new ScoreBreakdown("P/L (TTM)", indicators.getPeRatio(), 25, pePoints,
            "P/L entre 6 e 15 e saudavel; acima de 25 perde todos os pontos."));
        ...
        parts.add(new ScoreBreakdown("EPS positivo", indicators.getEps(), 10, epsPoints,
            epsPoints > 0 ? "EPS > 0 soma estabilidade." : "EPS negativo zera este criterio."));
        ...
        parts.add(new ScoreBreakdown("Porte (Market Cap)", indicators.getMarketCap(), 10, sizePoints,
            "Acima de US$10B recebe nota maxima; abaixo de US$2B zera."));

        double resiliencePoints = 5; // bonus fixo, evita score muito baixo se demais dados faltarem.
        total += resiliencePoints;
        parts.add(new ScoreBreakdown("Bonus de estabilidade", null, 5, resiliencePoints,
            "Pequeno bonus para compensar eventuais dados ausentes."));
